...
const ModalNonactive = ({ targetId, modalNonactive, setModalNonactive }) => {
  ...
  const handleNonactive = async () => {
    const result = await httpPostNonactive(
      "http://103.87.78.74/mhg_api/api/admin/specialist/nonactive",
      "specialist_id",
      targetId
    );
    ...
    <>
      ...
      >
        <i
          ...
          style={{ fontSize: "5rem" }}
        />
        <p>Apakah Anda ingin menonaktifkan data spesialisasi ini?</p>
      </Dialog>
      ...
      >
        ...
        <p>
          {modalResponse === "success"
            ? "Data spesialisasi berhasil dinonaktifkan."
            : "Terjadi kesalahan."}
        </p>
      </Dialog>
    </>
