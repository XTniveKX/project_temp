...
const ModalNonactive = ({ targetId, modalNonactive, setModalNonactive }) => {
  ...
  const handleNonactive = async () => {
    const result = await httpPostNonactive(
      "http://103.87.78.74/mhg_api/api/admin/hospital/nonactive",
      "hospital_id",
      targetId
    );
    ...
    <>
      ...
      >
        <i
          ...
          style={{ fontSize: "5rem" }}
        />
        <p>Apakah Anda ingin menonaktifkan data rumah sakit ini?</p>
      </Dialog>
      ...
      >
        ...
        <p>
          {modalResponse === "success"
            ? "Data rumah sakit berhasil dinonaktifkan."
            : "Terjadi kesalahan."}
        </p>
      </Dialog>
    </>
