  ...
  return (
    <>
      ...
      >
        <div className="field mt-3">
          ...
          <Dropdown
            ...
            className="w-full"
            options={doctors.map((item) => item.doctor_id)}
            optionLabel={(option) =>
              `${option} - ${
                doctors.find((item) => item.doctor_id === option)
                  ?.doctor_name
              }`
            }
            placeholder={formValues.doctor_id}
          />
        </div>
      </Dialog>
      ...
      >
        ...
        <p>
          {modalResponse === "success"
            ? `Data dokter rumah sakit berhasil ${targetId ? "diubah" : "dibuat"}.`
            : "Terjadi kesalahan."}
        </p>
      </Dialog>
    </>
