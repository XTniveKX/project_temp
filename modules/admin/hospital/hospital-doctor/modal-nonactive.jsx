...
const ModalNonactive = ({ targetId, modalNonactive, setModalNonactive }) => {
  ...
  const handleNonactive = async () => {
    const result = await httpPostNonactive(
      "http://103.87.78.74/mhg_api/api/admin/hospital-doctor/nonactive",
      "hospital_doctor_id",
      targetId
    );
    ...
    <>
      ...
      >
        <i
          ...
          style={{ fontSize: "5rem" }}
        />
        <p>Apakah Anda ingin menonaktifkan data dokter rumah sakit ini?</p>
      </Dialog>
      ...
      >
        ...
        <p>
          {modalResponse === "success"
            ? "Data dokter rumah sakit berhasil dinonaktifkan."
            : "Terjadi kesalahan."}
        </p>
      </Dialog>
    </>
